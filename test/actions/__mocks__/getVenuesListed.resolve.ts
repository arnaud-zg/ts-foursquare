          ...
          items: [
            {
              ...
              canonicalUrl:
                'https://foursquare.com/thesparkgroup/list/nyc-bars-w-free-wifi',
            ...
            },
            {
              ...
              name: 'Summer Parties',
              description:
                'Put on your dancing shoes and head to these sizzling spots for summer’s hottest parties.',
              type: 'others',
              user: {
                id: '742542',
              ...
              canonicalUrl:
                'https://foursquare.com/timeoutnewyork/list/summer-parties',
              ...
              photo: {
                ...
                prefix: 'https://igx.4sqi.net/img/general/',
                suffix:
                  '/742542_FrC-C6NUK0-7sjuLGQcVvyDcQhAhlfjd8Ghw_FxJigE.jpg',
                width: 555,
                height: 370,
                user: {
                  id: '742542',
                ...
                items: [
                  {
                    ...
                    photo: {
                      ...
                      prefix: 'https://igx.4sqi.net/img/general/',
                      suffix:
                        '/742542_Vj4eR1iQui22nyGV4G-xvfruWkRmr7hcOwXMaPbwVho.jpg',
                      width: 555,
                      height: 370,
                      user: {
                        id: '742542',
