...
describe('epics/venues', () => {
  ...
  test.each`
    ...
    ${'should get search for venues by location'} | ${requestGetVenuesSearch({ ll: '40.7099,-73.9622' })} | ${[{
  ...
  intent: 'browse',
  radius: 500,
})} | ${[{ payload: payload.response.venues, type: EVenuesAction.RESOLVE_GET_VENUES_SEARCH }]}
